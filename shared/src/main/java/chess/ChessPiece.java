    ...
    */
    ...
    private Collection<ChessMove> King (ChessBoard board, ChessPosition position) {
        ...
        if (row < 8) {
            ...
            if (board.getPiece(new ChessPosition(row + 1, col)).getTeamColor() != pieceColor) {
        ...
        if (col < 8) {
            // get right side
            if (board.getPiece(new ChessPosition(row, col + 1)).getTeamColor() != pieceColor) {
    ...
    private Collection<ChessMove> Straight (ChessBoard board, ChessPosition position) {
        ...
        if (row + x < 9 && board.getPiece(new ChessPosition(row + x, col)).getTeamColor() != pieceColor) {
            // capture piece
            moves.add (new ChessMove(position, new ChessPosition(row + x, col), null));
        }
        ...
        if (row - x > 0 && board.getPiece(new ChessPosition(row - x, col)).getTeamColor() != pieceColor) {
            // capture piece
            moves.add (new ChessMove(position, new ChessPosition(row - x, col), null));
        }
        ...
        if (col + x < 9 && board.getPiece(new ChessPosition(row, col + x)).getTeamColor() != pieceColor) {
            // capture piece
            moves.add (new ChessMove(position, new ChessPosition(row, col + x), null));
        }
        ...
        if (col - x > 0 && board.getPiece(new ChessPosition(row, col - x)).getTeamColor() != pieceColor) {
            // capture piece
            moves.add (new ChessMove(position, new ChessPosition(row, col - x), null));
        }
